...
- Deploy and configure ** Microsoft Defender for Cloud Apps and Endpoint and 365 **
...
- Microsoft Defender for Cloud Apps and Endpoint and 365
- Virtual Machines (Windows & Linux)
- Simulated attack scenarios
- Data connectors (e.g., Azure Activity, MDE, Syslog)
